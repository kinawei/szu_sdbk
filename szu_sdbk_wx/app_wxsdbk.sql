...
CREATE TABLE IF NOT EXISTS `ims_mc_mapping_fans` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15808 ;
...
CREATE TABLE IF NOT EXISTS `ims_mc_members` (
  ...
  KEY `email` (`email`),
  KEY `mobile` (`mobile`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15810 ;
...
CREATE TABLE IF NOT EXISTS `ims_stat_msg_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_createtime` (`createtime`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=101848 ;
...
CREATE TABLE IF NOT EXISTS `ims_stat_rule` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `rid` (`rid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=51323 ;
...
CREATE TABLE IF NOT EXISTS `ims_userapi_cache` (
  ...
  `lastupdate` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11256 ;
